...
public class GeneticAlgorithm
{
    ...
    /// Mutira zadani genotip dodavanjem nasumične vrijednosti 
    /// u rasponu [-mutationAmount, mutationAmount] svakom parametru s vjerojatnošću mutationProb.
    public static void MutateGenotype(Genotype genotype, float mutationProb, float mutationAmount)
    {
        for (int i = 0; i < genotype.ParameterCount; i++)
        {
            ...
            {
                //Mutiranje nasumičnom količinom u rasponu [-mutationAmount, mutationAmoun]
